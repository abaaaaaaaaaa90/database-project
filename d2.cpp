...
bool Class_Name(string &pointer); //porototype//
...
bool IsOrIsnt(string &Str); //porototype//
...
void LowToUp(string &pointer); //porototype//
void LowToUp2(string &pointer); //porototype//
